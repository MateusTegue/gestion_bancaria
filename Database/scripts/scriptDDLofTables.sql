...
(
    ...
    USUARIO VARCHAR2(35) NOT NULL UNIQUE,
...
COMMENT ON COLUMN PROYECTODB.TBL_AUDITORIA_TRANSACCIONES.CUENTA_ID IS 'ID de la cuenta';
...
CREATE INDEX IDX_CUENTA_ID_AUDITORIA
    ON PROYECTODB.TBL_AUDITORIA_TRANSACCIONES(CUENTA_ID)
    TABLESPACE PROYECTODB_IDX;

ALTER TABLE PROYECTODB.TBL_AUDITORIA_TRANSACCIONES ADD CONSTRAINT FK_CUENTA_ID_AUDITORIA FOREIGN KEY (CUENTA_ID)
    REFERENCES PROYECTODB.TBL_CUENTAS(CUENTA_ID);
