...
(
    ...
    ESTADO_ID NUMBER(10) NOT NULL DEFAULT 1,
    SALDO NUMBER(15,2) NOT NULL DEFAULT 0
)TABLESPACE PROYECTO_DAT;
...
ALTER TABLE PROYECTODB.TBL_CUENTAS ADD CONSTRAINT PK_CUENTA_ID PRIMARY KEY (CUENTA_ID)
...
ALTER TABLE PROYECTODB.TBL_CUENTAS ADD CONSTRAINT FK_CLIENTE_ID FOREIGN KEY (CLIENTE_ID)
...
(
    ...
    FECHA_TRANSACCION DATE NOT NULL DEFAULT SYSDATE
) TABLESPACE PROYECTO_DAT;
...
ALTER TABLE PROYECTODB.TBL_USUARIOS ADD CONSTRAINT FK_CLIENTE_ID FOREIGN KEY (CLIENTE_ID)
    REFERENCES PROYECTODB.TBL_CLIENTES(CLIENTE_ID);
